...
This project is indexed by GitNexus as **MA6_Debt** (10979 symbols, 20053 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/MA6_Debt/context` | Codebase overview, check index freshness |
| `gitnexus://repo/MA6_Debt/clusters` | All functional areas |
| `gitnexus://repo/MA6_Debt/processes` | All execution flows |
| `gitnexus://repo/MA6_Debt/process/{name}` | Step-by-step execution trace |
