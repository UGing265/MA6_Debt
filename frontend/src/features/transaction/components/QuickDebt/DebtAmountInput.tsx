...
export const DebtAmountInput: React.FC<DebtAmountInputProps> = ({ value, onChange, disabled, error }) => {
  ...
  return (
    <div className="space-y-1.5">
      <label className="block text-left text-xs font-semibold text-ink-black">{t.quickDeduct.page.debtAmount}</label>
      <div className="relative">
        <input
          ...
          type="text"
          value={value ? value.toLocaleString(locale === "vi" ? "vi-VN" : "en-US") : ""}
