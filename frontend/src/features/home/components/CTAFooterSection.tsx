    ...
    <div className="flex flex-col w-full">
      <section className="bg-[#FFFBEB] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/register"
            className="font-quicksand inline-block border-2 border-[#E8CB50] bg-[#F0D25D] text-white font-semibold px-10 py-4 rounded-full hover:bg-[#E8CB50] transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            Try Now
          </Link>
        </div>
