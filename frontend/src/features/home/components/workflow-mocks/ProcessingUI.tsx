          ...
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-1.5">
              <div className="p-1 bg-[#F5EFE6] rounded text-[#FF7A00]">
               ...
               <span className="text-[10px] font-bold text-[#4A2C2A]">{t.home.workflow.mock.processing.subWallet}</span>
             </div>
             <span className="text-[9px] font-medium text-[#8D6E63]">{t.home.workflow.mock.processing.sending}</span>
           </div>
        ...
        <div className="relative h-8 w-full flex items-center justify-center">
           ...
           <div className="absolute right-0 top-1/2 -translate-y-1/2 bg-[#FF7A00]/10 text-[#FF7A00] text-[8px] font-bold px-1.5 py-0.5 rounded-full flex items-center gap-0.5">
              <RefreshCw size={8} className="animate-spin" />
               {t.home.workflow.mock.processing.syncing}
            </div>
         </div>
            ...
            <div className="flex items-center justify-between mb-1.5">
              <div className="flex items-center gap-1.5">
                <div className="p-1 bg-white/10 rounded text-white">
                 ...
                 <span className="text-[10px] font-bold">{t.home.workflow.mock.processing.parentWallet}</span>
               </div>
               <span className="text-[9px] font-medium text-white/80">{t.home.workflow.mock.processing.receiving}</span>
             </div>
            <div className="flex justify-between items-center">
